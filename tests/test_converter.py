...
def test_version_tuple_to_str(version: tuple[int, ...], expected_output: str) -> None:
...
def test_version_str_to_tuple(version: str, expected_output: tuple[int, ...]) -> None:
    """Should return correct tuple given a version str"""
...
def test_version_str_to_tuple_bad_input(version: str) -> None:
